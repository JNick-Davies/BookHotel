    ...
    internal sealed class Configuration : DbMigrationsConfiguration<BookHotel.Data.ApplicationDbContext>
    {
        ...
        protected override void Seed(BookHotel.Data.ApplicationDbContext context)
        {
            ...
            context.Inncodes.AddOrUpdate(x => x.HotelInnCode,
                new InnCode { HotelInnCode = "INDMS", HotelName = "Hooiser House on Main", HotelAddress = "101 Main Street", HotelPhoneNumber = 317 - 555 - 6789, HasSpa = false, HasGolfCourse = false, HasRooftopBar = true, NumberOfStars = 3 },
                new InnCode { HotelInnCode = "INDCD", HotelName = "Carmel Delights Resort and Spa", HotelAddress = "479 Carmel Drive", HotelPhoneNumber = 317 - 555 - 5678, HasSpa = true, HasGolfCourse = true, HasRooftopBar = true, NumberOfStars = 5 },
                new InnCode { HotelInnCode = "INDAP", HotelName = "Indianapolis Inn at the Airport", HotelAddress = "324 Wier Drive", HotelPhoneNumber = 317 - 555 - 2345, HasSpa = false, HasGolfCourse = false, HasRooftopBar = false, NumberOfStars = 2 },
